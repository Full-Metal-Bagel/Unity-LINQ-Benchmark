...
public record struct LinqGenFunc(int local) : IStructFunction<int, double>
{
...
{
    public static ReadOnlyListEnumerable<T> AsStructEnumerable<T>(this IReadOnlyList<T> list)
    {
        return new ReadOnlyListEnumerable<T>(list);
    }
    
    public record struct ReadOnlyListEnumerable<T>(IReadOnlyList<T> List) : Cathei.LinqGen.IStructEnumerable<T, ReadOnlyListEnumerable<T>.Enumerator>
    {
